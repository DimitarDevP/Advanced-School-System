...
export const getAbscences = () => {
    return (dispatch, getState) => {
        ...
        Axios.post("http://6a080d6864eb.ngrok.io/api/abscences/get_abscences", {auth_key: getState().currentUser.auth_key})
        .then(response => {
...
export const setAbscencesStatus = abscencesArray => {
    return (dispatch, getState) => {
        ...
        Axios.defaults.withCredentials = true
        Axios.post("http://6a080d6864eb.ngrok.io/api/abscences/set_abscences_status", data)
        .then(response => {
...
export const addAbscence = abscence => {
    return (dispatch, getState) => {
        ...
        Axios.defaults.withCredentials = true
        Axios.post("http://6a080d6864eb.ngrok.io/api/abscences/add_abscences", data)
        .then(response => {
