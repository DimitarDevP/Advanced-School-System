...
export const createSubject = (data) => {
    return (dispatch, getState) => {
        ...
        Axios.post("http://6a080d6864eb.ngrok.io/api/subjects/create_subject", data)
        .then(response => {
...
export const enrollSubject = (subject_id) => {
    return (dispatch, getState) => {
        ...
        Axios.post("http://6a080d6864eb.ngrok.io/api/subjects/enroll_subject", data)
        .then(response => {
...
export const getAllSubjects = () => {
    return (dispatch, getState) => {
        ...
        Axios.defaults.withCredentials = true
        Axios.get("http://6a080d6864eb.ngrok.io/api/subjects/get_all_subjects")
        .then(response => {
...
export const getEnrolledSubjects = () => {
    return (dispatch, getState) => {
        Axios.defaults.withCredentials = true
        Axios.get("http://6a080d6864eb.ngrok.io/api/subjects/get_enrolled_subjects")
        .then(response => {
...
export const getSubjectClasses = (subject_id) => {
    return (dispatch, getState) => {
        Axios.defaults.withCredentials = true
        Axios.post("http://6a080d6864eb.ngrok.io/api/subjects/get_subject_classes", {"subject_id": subject_id})
        .then(response => {
